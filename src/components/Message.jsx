...
const Corner = ({ bg, border }) => {
  ...
  return (
    <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" clipRule="evenodd" d="M8 8.5V0.5C12.4183 0.5 16 4.08172 16 8.5C16 12.9183 12.4183 16.5 8 16.5H0C4.41828 16.5 8 12.9183 8 8.5Z" fill={bg} />
...
const Message = ({ children, author, date, avatar }) => {
  ...
  return (
    <Flex className="message" gap='12px' alignItems='flex-end'>
      ...
      <Box border={`0.5px solid ${background.default}`} position='relative' bg={background.paper} borderRadius='16px' wordBreak={true} p='8px 12px' maxW='320px'>
