  ...
  return (
      <Flex sx={{
        ...
        <Box sx={{
          ...
          <Heading p={'4px 16px 4px 24px'} background={'telegram.200'} borderRadius={'8px 20px 4px 20px'} fontSize={'lg'} position={'absolute'} bottom={'0'} left={'0'}>{getShopName(shop)}</Heading>
        </Box>
